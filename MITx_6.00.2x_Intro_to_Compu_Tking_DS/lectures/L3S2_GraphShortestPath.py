...
def testSP(source, destination):
    ...
    spBFS = shortestPathBFS(g, g.getNode(source), g.getNode(destination),
                      toPrint = False)
    spDFS = shortestPathDFS(g, g.getNode(source), g.getNode(destination),
                            toPrint=False)

    if spBFS != None:
        print('BFS Shortest path from', source, 'to',
              destination, 'is', printPath(spBFS))
        print('DFS Shortest path from', source, 'to',
                 destination, 'is', printPath(spDFS))
